...
You will also need [ 3](http://.org/) with
[PyYAML](https://pypi..org/pypi/PyYAML/) available in  to
...
*   `make clean` removes the `_site` directory and any Emacs  backup files littering the source directories.
